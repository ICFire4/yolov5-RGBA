...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        model = Model(cfg or ckpt['model'].yaml, ch=data_dict['ch'] if 'ch' in data_dict else 3, nc=nc, anchors=hyp.get('anchors')).to(device)  # create
        ...
        model = Model(cfg, ch=data_dict['ch'] if 'ch' in data_dict else 3, nc=nc, anchors=hyp.get('anchors')).to(device)  # create
